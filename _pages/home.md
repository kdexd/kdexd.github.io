...
<div class="row">
  ...
  -->
  <div class="col-sm-4 col-xs-12"><img alt="{{ site.author.name }}" id="display-pic" src="/static/img/kd4.jpeg"></div>
...
<div class="row">
  <div class="col">
    <h2 style="display: inline-block">Side Projects</h2>
    <h4 style="display: inline-block; margin-left: 10px; color: #666">(before grad school)</h4>
  </div>
</div>

<div class="card-row row">
  <div class="col-sm-4 col-xs-12">
    <img src="/static/img/lang_emerge_banner.jpeg" alt="lang-emerge-parlai" title="language emergence"/>
  </div>
  <div class="col-sm-8 col-xs-12">
    <span class="card-title">
      <a href="//github.com/kdexd/lang-emerge-parlai"><i class="fab fa-github"></i></a> lang-emerge-parlai
    </span>
    <br />
    <span class="card-desc">
      PyTorch implementation of the EMNLP 2017 paper
      <a href="//arxiv.org/abs/1706.08502">
      "Natural Language Does Not Emerge 'Naturally' in Multi-Agent Dialog"</a>.
    </span>
  </div>
</div>
...
<div class="card-row row">
  <div class="col-sm-4 col-xs-12">
    <img src="/static/img/trianglify_banner.jpeg" alt="trianglify" title="trianglify"/>
  </div>
  <div class="col-sm-8 col-xs-12">
    <span class="card-title">
      <a href="//github.com/mdgiitr/trianglify"><i class="fab fa-github"></i></a> trianglify
    </span>
    <br />
    <span class="card-desc">
      Trianglify is a highly customizable library to generate beautiful triangle art views for android.
      Uses the Delaunay Triangulation algorithm under the hood.
    </span>
  </div>
</div>
...
<div class="card-row row">
  <div class="col-sm-4 col-xs-12">
    <img src="/static/img/yolog_banner.jpeg" alt="yolog" title="yolog"/>
  </div>
  <div class="col-sm-8 col-xs-12">
    <span class="card-title">
      <a href="//github.com/kdexd/yolog"><i class="fab fa-github"></i></a> yolog
    </span>
    <br />
    <span class="card-desc">
...
<div class="card-row row">
  ...
  <div class="col-sm-4 col-xs-8">
    ...
    <br />
    <span class="card-desc">
      My first github repository (2015), browser-based snake game implemented in JavaScript.
      The game still works on <a href="//kdexd.github.io/snake">Github pages</a>!
    </span>
  </div>
</div>
...
<script>
  ...
  var colors = ["#1976d2", "#e64a19", "#388e3c", "#8d6e63"];
  var id = -1;
